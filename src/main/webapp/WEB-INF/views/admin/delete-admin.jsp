...
<html lang="pl">
<head>
    <spring:message code="pages.admin.delete-admin.title" var="title"/>
...
<section class="login-page">
    <h2><spring:message code="pages.admin.delete-admin.header"/></h2>
    ...
    <form:form method="get" action="/admin/admins-all">
        <div class="form-group form-group--buttons">
