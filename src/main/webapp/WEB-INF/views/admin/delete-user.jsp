...
<html lang="pl">
<head>
    <spring:message code="pages.admin.delete-user.title" var="title"/>
...
<section class="login-page">
    <h2><spring:message code="pages.admin.delete-user.header"/></h2>
    ...
    <form:form method="get" action="/admin/users-all">
        <div class="form-group form-group--buttons">
